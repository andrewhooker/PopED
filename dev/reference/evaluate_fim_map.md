...
Computation of the Bayesian Fisher information matrix for individual
parameters of a population model based on Maximum A Posteriori (MAP)
estimation of the empirical Bayes estimates (EBEs) in a population model
...
- shrink_mat:
  ...
  Should the shrinkage matrix be returned. Calculated as the inverse of
  the Bayesian Fisher information matrix times the inverse of the omega
  matrix (variance matrix of the between-subject variability).
