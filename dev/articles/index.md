...
- [Introduction to
  PopED](https://andrewhooker.github.io/PopED/dev/articles/intro-poped.md):
- [Defining models for PopED using R based PKPD
  simulators](https://andrewhooker.github.io/PopED/dev/articles/model_def_other_pkgs.md):
