emax.sigmoidal.dose.design.1.input <- function(){
    ...
    popedInput$design$ni=rbind(8)
    
    maxxt <- 50
    minxt <- 0
    ## -- Matrix defining the max value for each sample --
    popedInput$design$maxxt=rbind(rep(maxxt,popedInput$design$ni))
    ## -- Matrix defining the min value for each sample --
    popedInput$design$minxt=rbind(rep(minxt,popedInput$design$ni))
    ## -- Matrix defining the initial sampling schedule --
    popedInput$design$xt=rbind(seq(minxt,maxxt,length.out=popedInput$design$ni))
    
    ## -- Matrix defining the initial discrete values --
    popedInput$design$x=matrix(0,popedInput$m,0)
    ## -- Cell defining the discrete variables --
    popedInput$design$discrete_x=cell(popedInput$m,0)
    ## -- Vector defining the initial covariate values --
    popedInput$design$a=matrix(0,popedInput$m,0)
    ## -- Vector defining the max value for each covariate --
    popedInput$design$maxa=matrix(0,popedInput$m,0)
    ## -- Vector defining the min value for each covariate --
    popedInput$design$mina=matrix(0,popedInput$m,0)
    ## -- Vector defining which response a certain sampling time belongs to --
    popedInput$design$model_switch=matrix(1,nrow=nrow(popedInput$design$xt),ncol=ncol(popedInput$design$xt))
    ## -- Use grouped time points (1=TRUE, 0=FALSE) --
    popedInput$bUseGrouped_xt=0
    ## -- Matrix defining the grouping of sample points --
    popedInput$design$G=matrix(rep(1:length(popedInput$design$xt)),nrow=nrow(popedInput$design$xt),ncol=ncol(popedInput$design$xt))
    ## -- Use grouped covariates (1=TRUE, 0=FALSE) --
    popedInput$bUseGrouped_a=0
    ## -- Matrix defining the grouping of covariates --
    popedInput$design$Ga=matrix(0,popedInput$m,0)
    ...
    popedInput$design$Gx=matrix(0,popedInput$m,0)
    ...
    popedInput$design$bpop=rbind(c(4,100,(.25*100)^2),
                                 c(4,20,(.25*20)^2),
                                 c(4,4.5,(.25*4.5)^2),
                                 c(0,1,0))
    ## -- Matrix defining the diagnonals of the IIV (same logic as for the fixed efects) --
    popedInput$design$d=rbind(c(4,.25^2,(.25*(0.25^2))^2),
                              c(4,.25^2,(.25*(0.25^2))^2),
                              c(4,.25^2,(.25*(0.25^2))^2),
                              c(0,0,0))
    ...
    popedInput$design$sigma <- diag(c(0.0025,25))
    ...
    popedInput$notfixed_d=cbind(1,1,1,0)
    ...
    popedInput$notfixed_sigma <- cbind(1,0)
