warfarin.design.5.input <- function(){
  ...
  popedInput$design$x=rbind(70, 70, 70, 70)
  ## -- Cell defining the allowed discrete variables --    
  foo <- cell(4,1)
  foo[1,1] <- list(seq(10,100,10))
  foo[2,1] <- list(seq(10,100,10))
  foo[3,1] <- list(seq(10,100,10))
  foo[4,1] <- list(seq(10,100,10))
  popedInput$design$discrete_x=foo
  ## -- Vector defining the initial covariate values --
  popedInput$design$a=matrix(0,4,0)
  ## -- Vector defining the max value for each covariate --
  popedInput$design$maxa=matrix(0,4,0)
  ## -- Vector defining the min value for each covariate --
  popedInput$design$mina=matrix(0,4,0)
  ...
  popedInput$design$Ga=matrix(0,4,0)
  ...
  popedInput$design$Gx=rbind(1, 2, 3, 4)
  ...
  popedInput$fg_file='sfg.discrete'
  ...
  popedInput$iNumSearchIterationsIfNotLineSearch=10
