warfarin.design.3.input <- function(){
    ...
    popedInput$design$Gx=matrix(0,1,0)
    ...
    popedInput$design$sigma <- cbind(0.01)
    ...
    popedInput$CriterionOptions$ds_index <- cbind(0,0,0,0,0,0,0)
    ...
    popedInput$fError_file='feps.prop'
    ## -- The model title --
