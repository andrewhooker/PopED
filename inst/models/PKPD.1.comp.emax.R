PKPD.1.comp.emax.fg <- function(x,a,bpop,b,bocc){
...
PKPD.1.comp.emax.ff <- function(model_switch,xt,parameters,poped.db){
...
PKPD.1.comp.emax.feps <- function(model_switch,xt,parameters,epsi,poped.db){
...
poped.db <- create.poped.database(ff_file="PKPD.1.comp.emax.ff",
                                  fError_file="PKPD.1.comp.emax.feps",
                                  fg_file="PKPD.1.comp.emax.fg",
                                  groupsize=20,
                                  m=3,
