...
dfimdalpha <- function(alpha, model_switch,groupsize,ni,xtoptn,xoptn,aoptn,bpopdescr,ddescr,covd,sigma,docc,globalStructure,ha){
  ...
  for(i in 1:length(alpha)){
    ...
    if((i>sum(bpopdescr[,1]!=0))){
      ...
      fim_minus=mftot(model_switch,groupsize,ni,xtoptn,xoptn,aoptn,bpop,d,sigma,docc,globalStructure)
