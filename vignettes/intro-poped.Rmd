...
```
## Examples
1.	One comp first order absorption - Analytic solution for both mutiple and single dosing (design evaluation and optimization)	
2.	PKPD model (analytical equations) & multiple arms (different doses, sampling times)	
3.	Two compartment model with oral absorption using ODEs	
...
Further examples	
13.	Shrinkage	
14.	Irregular dosing more complex: e.g. switching between s.c. and i.v. within one arm.	
15.	Constraining the optimization to different allowed sampling times for each group	
16.	Constraining the optimization to different allowed sampling times for each response	
17.	Keep some sampling time fixed (they will be automatically part of the optimal design protocol)	
18.	Handling derived outputs	
