...
NB !! I commented out the evaluation because it gives an error and the html file is not produced.
...
##7.	Model with Inter-occasion variability (and full covariance matrix	TO BE ADDED)

The full code for this example is available at the usual PopED examples directory, under the name of "model_with_iov.R"

TODO: reduce example and add commentsFIX bug 

"Error in bocc[1, 1] : incorrect number of dimensions
In addition: Warning message:
In find.largest.index(poped.db$model$fg_pointer, "bocc", mat = T,  :
