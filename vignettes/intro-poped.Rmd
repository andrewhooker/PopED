...
1.	One comp first order absorption - Analytic solution for both mutiple and single dosing (design evaluation)	
2.	Example 1 with optimization of times and/or doses using different methods	

##3.	PKPD model (analytical equations) & multiple arms (different doses, sampling times)	
