...
# Design optimization
Now we can optimize the sample times of the origianl design by maximizing the OFV^[Tip:  to make the optimization run faster use the option `parallel = TRUE` in the `poped_optim` command.].
