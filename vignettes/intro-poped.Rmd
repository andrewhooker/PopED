...
In ex.8.tmdd_qss_one_target_compiled.R there is an example of different sampling schemes per arm using matrices. This starts at line 190. (Waiting for nice and compressed version of the example from Martin)
